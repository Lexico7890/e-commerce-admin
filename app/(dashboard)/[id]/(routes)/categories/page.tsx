...
const PageCategories = () => {
  return (
    <div className="flex justify-between px-4">
      ...
      <button
        type="button"
        className="text-custom-green-neon font-semibold hover:text-black border border-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-yellow-300 text-sm px-5 py-2.5 text-center dark:border-custom-green-neon dark:text-custom-green-neon dark:hover:text-black dark:hover:bg-custom-green-neon dark:focus:ring-yellow-900"
      >
        Nueva categoría
      </button>
    </div>
